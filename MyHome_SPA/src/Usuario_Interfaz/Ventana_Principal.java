...
private void estilizarBotonMint(javax.swing.JButton boton, java.awt.Color color) {
    ...
    boton.setPreferredSize(new java.awt.Dimension(145, 28));
}
...
private boolean validarFecha(String fecha) {
    ...
    private String obtenerEstado(String nombreElemento, String accion) {

    String terminacion;

    switch (nombreElemento.toLowerCase()) {
    ...
    return nombreElemento + " " + accion + terminacion + " correctamente.";
}
...
private void guardarResumenFinanciero(BufferedWriter bw) throws IOException {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jButtonCargarTxT, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(jTextFieldCocinas)))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGap(29, 29, 29)
                                .addComponent(jButtonAgregarVivienda)
                                .addGap(18, 18, 18)
        ...
        jButtonAgregarComercial.setText("Agregar Comercial");
        ...
        jButton3.setText("Eliminar Comercial");
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel8Layout.createSequentialGroup()
                                ...
                                .addComponent(jButtonAgregarComercial)
                                .addGap(18, 18, 18)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButtonRegistarVisita, javax.swing.GroupLayout.Alignment.TRAILING)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        .addComponent(jButtonRegistarVisita)
                        .addGap(18, 18, 18)
        ...
        jButtonRegistrarCierre.setText("Registrar Cierre");
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel4Layout.createSequentialGroup()
                                        ...
                                        .addGap(46, 46, 46)
                                        .addComponent(jButtonRegistrarCierre)
                                        .addGap(18, 18, 18)
    ...
    private void jButtonAgregarViviendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarViviendaActionPerformed
        ...
        try {
            ...
            String refFinal = "VIV-" + refIngresada;
            double precioInitial = 0.0; // Exigido por herencia

            Inmuebles.Vivienda nuevaVivienda = new Inmuebles.Vivienda(
            ...
            String distribucion = nuevaVivienda.getHabitaciones() + " hab, " + nuevaVivienda.getBanos() + " baños, " + nuevaVivienda.getCocinas() + " coc";
    ...
    private void jButtonAgregarComercialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAgregarComercialActionPerformed
        ...
        try {
            ...
            if (tipo.equalsIgnoreCase("BODEGA")) {
                Inmuebles.Bodega nuevaBodega = new Inmuebles.Bodega(
            ...
            modelo.addRow(new Object[]{
                ...
                Inmuebles.Local_Comercial nuevoLocal = new Inmuebles.Local_Comercial(
                    nPuertas, tieneVentanas, esAcondicionado, refFinal, direccion, m2, valor, precioInicial
                );
    ...
    private void jButtonRegistarVisitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegistarVisitaActionPerformed
        ...
        String refInmueble = jTextFieldRefInmuebleVisita.getText().trim().toUpperCase();
